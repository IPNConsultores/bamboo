...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    //Mostramos los titulos de los articulos o lo que deseemos...
        ...
        $correo=$row->correo;
        $num=$num+1;
        $lista=$lista.'<tr><td>'.$num.'</td><td>'.$rut.'</td><td>'.$nombre.'</td><td>'.$telefono.'</td><td>'.$correo.'</td><td><button id="boton-modificar" onclick="location.href=\'modificacion_cliente.php?cliente='.$id.'\'">modificar</button></td><tr>'. "<br>";
    }
