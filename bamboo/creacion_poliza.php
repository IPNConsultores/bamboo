...
<div class="accordion" id="accordionExample">
  ...
  <div class="card" >
    <div class="card-header" id="headingTwo" style="background-color:whitesmoke">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" style="color:#536656">Compañía, Vigencia, Materia y Deducible</button>
      </h5>
    </div>
      ...
      <div class="card-body">
        ...
        <div class ="form-row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <div class="md-form">
              <input placeholder="Selected date" type="date" id="fechadeposito" class="form-control">
            </div>
          </div>
        </div>
        <br>
        ...
        <div class="form-row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <div class="md-form">
              <input placeholder="Selected date" type="date" id="fechaprimer" class="form-control">
            </div>
          </div>
        </div>
		  <br>
