...
$fech_cancela = estandariza_info($_POST["datofecha_cancelacion"])?'': estandariza_info($_POST["infofecha_cancelacion"]);
$motivo_cancela = estandariza_info($_POST["datomotivo_cancela"]) + '' + estandariza_info($_POST["infomotivo_cancela"]);
