    ...
    <div class="container">
        ...
        <form action="/bamboo/backend/clientes/crea_cliente.php" class="needs-validation" method="POST" novalidate>
            ...
            <div class="form-check form-check-inline">
                <label class="form-check-label" style="padding-left:5em">¿Quieres asociar algún contacto a este cliente
                    nuevo?:&nbsp;&nbsp;</label>
    ...
    if (cant_contact !== 0) {
        ...
        for ($k = 1; $k <= cant_contact; $k++) {
            ...
            var newElement = '<tr id =registro' + $k +
                '><td><input class="form-control" type="text" value="" id="nombrecontact' + $k +
                '" name="nombrecontact' + $k +
                '" /></td><td><input class="form-control" type="text" value="" id="telefonocontact' + $k +
                '" name="telefonocontact' + $k +
                '" /></td><td><input class="form-control" type="email" value="" id="emailcontact' + $k +
                '" name="emailcontact' + $k +
                '" /></td></tr>';
