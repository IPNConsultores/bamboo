...
<div id=titulo1 style="display:flex">
  <p>Propuesta de Póliza / Emisión de Póliza<br>
  </p>
</div>
...
<!-- --------------------------------------------                -->
      ...
      <div class="card-header" id="headingTwo" style="background-color:whitesmoke">
        <h5 class="mb-0">
          <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                            ...
                            style="color:#536656">Propuesta, Compañía, Vigencia, Materia y Deducible</button>
        </h5>
      </div>
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
        ...
        <div class="form-row">
            <div class="col-4">
              ...
              <label style="color: darkred">*</label>
              <input type="text" class="form-control" id="nro_seguimiento" name="nro_seguimiento">
            </div>
    ...
    <div class="card-header" id="headingThree" style="background-color:whitesmoke">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                            ...
                            style="color:#536656">Póliza, Comisiones y Método de Pagos</button>
      </h5>
    </div>
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body" id="card-body-three">
        <label for="propuesta"><b>Póliza</b></label>
        <br>
        <div class="form-row">
          <div class="col-md-4 mb-3">
            <label for="nro_propuesta">Número de Póliza</label>
            <input type="text" class="form-control" id="nro_poliza" name="nro_poliza">
          </div>
          <div class="col-md-4 mb-3">
            <label for="fechaprop">Fecha Emisión Póliza</label>
            <div class="md-form">
              <input placeholder="Selected date" type="date" name="fechaemision" id="fechaemision"
  ...
  <button class="btn" type="submit" style="background-color: #536656; color: white"
            id='boton_submit' onclick = "bPreguntar = false">Aceptar Propuesta</button>
  <button class="btn" type="submit" style="background-color: darkRed; color: white"
            id='boton_reject' onclick = "bPreguntar = false">Rechazar propuesta</button>
</form>
<br>
<br>
</div>
