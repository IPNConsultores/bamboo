...
$dbhost = 'localhost';
$BBDDs = array('asesori1_reccius_db_QA');
$dbuser = 'asesori1_cesnar';
$dbpass = 'YvKC1ely)E^D';
$backup_path= '/home/asesori1/Backup_mysql/';
...
if (!file_exists('/home/asesori1/Backup_mysql/'.$dbname)) {
mkdir('/home/asesori1/Backup_mysql/'.$dbname, 0755, true);}


$directorio  = scandir('/home/asesori1/Backup_mysql/'.$dbname.'/');
foreach ($directorio as $archivo) {
if (!is_dir($archivo))//verificamos si es o no un directorio
{
if (filemtime('/home/asesori1/Backup_mysql/'.$dbname.'/'.$archivo) < ( time() - ( $days * 24 * 60 * 60 ) ) )  
{  
unlink('/home/asesori1/Backup_mysql/'.$dbname.'/'.$archivo);  
} 
}
}
